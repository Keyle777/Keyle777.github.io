...
$.ajax({
    ...
    success: function (res) {
        ...
        function showWelcome() {
            ...
            let dist = getDistance(32.067487179911204, 118.79498705665915, ipLoacation.result.location.lng, ipLoacation.result.location.lat);
        ...
        你距离Keyle约有<span>${dist}</span>公里，${posdesc}
        <br>
        <br>
